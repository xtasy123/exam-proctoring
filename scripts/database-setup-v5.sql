...
('IT Admin', 'itadmin@itproctool.edu', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');
...
('Prof. Sarah Johnson', 'sarah.johnson@cec.edu', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Information Technology', 'EMP002'),
('Dr. Michael Brown', 'michael.brown@cec.edu', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Computer Science', 'EMP003'),
('Prof. Emily Davis', 'emily.davis@cec.edu', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Information Systems', 'EMP004'),
('Dr. Robert Wilson', 'robert.wilson@cec.edu', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Software Engineering', 'EMP005');
...
('Frank Taylor', 'STU006', 'frank.taylor@student.cec.edu', 'Information Systems', 2),
('Grace Lee', 'STU007', 'grace.lee@student.cec.edu', 'Software Engineering', 4),
('Henry Chen', 'STU008', 'henry.chen@student.cec.edu', 'Computer Science', 1),
('Ivy Rodriguez', 'STU009', 'ivy.rodriguez@student.cec.edu', 'Information Technology', 3),
('Jack Thompson', 'STU010', 'jack.thompson@student.cec.edu', 'Information Systems', 2);

-- Insert sample exams
INSERT INTO exams (title, description, form_url, duration_minutes, teacher_id, unique_id, status) VALUES
('Database Systems Midterm', 'Midterm examination covering database design and SQL', 'https://forms.google.com/database-midterm', 120, 1, 'DB2024001', 'active'),
('Programming Fundamentals Quiz', 'Weekly quiz on programming concepts', 'https://forms.google.com/prog-quiz', 60, 1, 'PROG2024001', 'draft'),
('Web Development Final', 'Final examination for web development course', 'https://forms.google.com/web-final', 180, 2, 'WEB2024001', 'draft');
...
('monitoring_interval', '5000', 'Monitoring check interval in milliseconds'),
('fullscreen_required', 'true', 'Require fullscreen mode during exams'),
('tab_switching_allowed', 'false', 'Allow tab switching during exams'),
('copy_paste_allowed', 'false', 'Allow copy and paste operations'),
('right_click_allowed', 'false', 'Allow right-click context menu');
